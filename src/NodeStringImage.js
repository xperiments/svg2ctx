...
var NodeStringImage = (function () {
    ...
    NodeStringImage.dec2hex = function dec2hex(i) {
        var hex = i.toString(16);
        hex = "000000".substr(0, 6 - hex.length) + hex;
        return hex;
    };
    NodeStringImage.hexToRgb = function hexToRgb(hex) {
    ...
    NodeStringImage.rgbToHex = function rgbToHex(r, g, b) {
        return ((1 << 24) + (r << 16) + (g << 8) + b).toString(16).slice(1, 7);
    };
    NodeStringImage.encode = function encode(str, width) {
    ...
    NodeStringImage.decode = function decode(imageData) {
    ...
    NodeStringImage.setPixel = function setPixel(imageData, x, y, r, g, b) {
...
//@ sourceMappingURL=NodeStringImage.js.map
